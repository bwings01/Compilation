...
board = []
undiscoveredTreasure = 0
# for loop to make the nested list row within the board to make the grid
for _ in range(height):
    row = []
    # for laying out the Os and Ts in the grid 
...
# while loop to start the game and take guess for to find treasure
